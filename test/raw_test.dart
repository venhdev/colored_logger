...
void main() {
  test('print raw', () {
    ...
    printEscCodes(doubleUnderline('Hello').toString(),
    ...
    try {
      printEscCodes(font('Hello', 0).toString(),
          label: 'Font 0 (should throw)');
    } catch (e) {
    ...
    print('\n=== 256-Color Support ===');
    printEscCodes(fg256('Hello', 208).toString(),
        label: 'Foreground 256 (208)');
    printEscCodes(bg256('Hello', 128).toString(),
        label: 'Background 256 (128)');
    try {
    ...
    printEscCodes(bold(alreadyStyled).toString(),
        label: 'Already styled + Bold');
    printEscCodes(StyledString('Hello', [Ansi.reset]).toString(),
        label: 'Reset');
